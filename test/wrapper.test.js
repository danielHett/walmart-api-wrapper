const { products, generateHeaders } = require('../src/wrapper');
...
describe('generateHeaders', () => {
    ...
    it('returns all results when numProducts is null', async () => {
        ...
        let actual = await products(headerData, null, '0');
        let expected = Array(450).fill(0)
    ...
    it('returns correct number of results when numProducts is less than MAX', async () => {
        ...
        let actual = await products(headerData, 34, '0');
        let expected = Array(34).fill(0)
        expect(actual).to.deep.equal(expected);
    ...
    it('returns correct number of results when numProducts is more than MAX', async () => {
        ...
        let actual = await products(headerData, 344, '0');
        let expected = Array(344).fill(0)
        expect(actual).to.deep.equal(expected);
